  ...
  return (
    <div className='flex flex-col mt-4 mx-auto text-neutral'>
      <div className='flex items-center gap-2 mb-4 px-2'>
        ...
        <div className='text-16-24 font-inter-600'>Cài đặt</div>
      </div>
      <div className='flex flex-col w-[800px] mb-4 rounded-lg bg-white mx-auto p-4 text-neutral'>
        <h2 className='text-20-28 font-inter-600 mb-4'>Nền tảng hỗ trợ</h2>
          ...
          {data?.publishedPlatforms?.map((platform: any) => (
            ...
            >
              <div className='col-span-6 flex items-center gap-4'>
                ...
                <div>
                  <h3 className='text-16-24 font-inter-600'>{platform.name}</h3>
                  <p className='text-14-20 font-inter-400 text-neutral'>{platform.description}</p>
                </div>
              </div>
              <div className='col-span-2 text-14-20 font-inter-500 flex justify-end items-center gap-2'>
                Chưa kết nối
              </div>
